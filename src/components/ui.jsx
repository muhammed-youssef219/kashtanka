function Icon({ name }) {
  const paths = {
    ...
    chat: (
      <>
        <path d="M12 5c-4.2 0-7.5 2.8-7.5 6.2 0 1.8.9 3.5 2.4 4.6-.2 1.3-.7 2.2-1.5 2.8 1.8 0 3.2-.7 4.1-1.5.5.1 1 .2 1.5.2 4.2 0 7.5-2.8 7.5-6.2S16.2 5 12 5Z" />
        <path d="M9 10h6M9 13h4" />
      </>
    ),
    bell: (
      <>
        <path d="M12 4.5c-3.2 0-5.5 2.3-5.5 5.8 0 2.5-.7 4.2-1.6 5.4-.6.8-.2 1.8.8 1.8h12.6c1 0 1.4-1 .8-1.8-.9-1.2-1.6-2.9-1.6-5.4 0-3.5-2.3-5.8-5.5-5.8Z" />
        <path d="M10.5 19.5c.8.6 2.2.6 3 0" />
      </>
    ),
    dog: (
      <>
        <path d="M7.5 9.5C6 9.5 5 11 5 13.5c0 2.2 1 3.8 2.2 3.8 1 0 1.8-1 1.8-2.8V9.5" />
        <path d="M16.5 9.5c1.5 0 2.5 1.5 2.5 4 0 2.2-1 3.8-2.2 3.8-1 0-1.8-1-1.8-2.8V9.5" />
        <path d="M7.5 9.5C7.5 6.5 9.5 5 12 5s4.5 1.5 4.5 4.5v4c0 3-2 5-4.5 5S7.5 16.5 7.5 13.5V9.5Z" />
        <circle cx="10" cy="10" r="0.75" fill="currentColor" stroke="none" />
        <circle cx="14" cy="10" r="0.75" fill="currentColor" stroke="none" />
        <ellipse cx="12" cy="12.3" rx="1.2" ry="0.85" fill="currentColor" stroke="none" />
